...
>
    {#if clickedDialogue}
        <div on:mousedown={startScale} class="top-left scale"></div>
        <div on:mousedown={startScale} class="top-right scale"></div>
        <div on:mousedown={startScale} class="bottom-left scale"></div>
        <div on:mousedown={startScale} class="bottom-right scale"></div>
    {/if}
</div>